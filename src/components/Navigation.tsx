    ...
    <AnimatePresence>
      {!isHiddenRoute && (
        ...
        >
          ...
          <div className="flex-1 max-w-[340px] p-2 flex items-center justify-between relative overflow-hidden rounded-[32px] bg-[#0A0A0A]/95 border border-white/[0.08] shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),inset_0_-1px_1px_rgba(0,0,0,0.5),0_16px_40px_rgba(0,0,0,0.8)]">
